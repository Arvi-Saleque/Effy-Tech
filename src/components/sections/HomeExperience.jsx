        ...
        <div className="home-shell">
          ...
          <div className="secondary-projects editorial-projects">
            <motion.article className="project-feature project-feature-eems" {...fade}>
              ...
              <div className="project-copy"><span>COACHING MANAGEMENT · 02</span><h3>Effy Edu Management System</h3><p><b>Problem:</b> Public content, student services, and recurring coaching operations were split across disconnected processes.</p><p><b>Solution:</b> One role-based platform with a public website, student portal, teacher/admin console, academic workflows, reporting, payments, and CMS.</p><ul><li>Status: Live client platform</li><li>Stack: Next.js · TypeScript</li><li>Outcome: Connected education operations</li></ul><Link href="/effy_edu_management_system">Launch full demo <ArrowRight size={15}/></Link></div>
            </motion.article>
