...
const capabilities = [
  {
    ...
    description:
      "Business websites, portals, dashboards, and web applications engineered around real operational workflows.",
    icon: Globe2,
  ...
  },
  {
    ...
    description:
      "Android, iOS, and cross-platform products with reliable architecture, offline capability, and polished interaction.",
    icon: Smartphone,
  ...
  },
  {
    ...
    description:
      "Management systems, internal tools, and connected workflows that reduce repetitive work and centralize operations.",
    icon: Workflow,
  ...
  },
  {
    ...
    description:
      "APIs, databases, authentication, cloud delivery, and practical AI features designed for controlled outcomes.",
    icon: Sparkles,
...
const process = [
  {
    n: "01",
    title: "Discover",
    text: "We map the business, users, constraints, and success criteria.",
    icon: Search,
  },
  {
    n: "02",
    title: "Architect",
    text: "We define the right product structure, workflow, and technical direction.",
    icon: Layers3,
  },
  {
    n: "03",
    title: "Build",
    text: "We design, develop, test, and refine the system in focused iterations.",
    icon: Code2,
  },
  {
    n: "04",
    title: "Launch",
    text: "We deploy, monitor, support, and improve the product after release.",
    icon: Rocket,
  },
];
...
const principles = [
  [
    ...
    "Technology follows the actual workflow and business objective.",
    CircuitBoard,
  ],
  [
    "Scalable engineering",
    "Clean architecture, clear boundaries, and room for future growth.",
    Database,
  ],
  [
    "Clear communication",
    "Direct updates, visible progress, and no unnecessary ambiguity.",
    Network,
  ],
  [
    "Long-term reliability",
    "Security, maintainability, and post-launch support are built in.",
    ShieldCheck,
  ],
];
...
const outcomes = [
  [
    "Faster operations",
    "Replace repeated manual work with structured digital workflows.",
    Gauge,
  ],
  [
    "Centralized management",
    "Control content, tasks, and operational data from one dependable system.",
    Building2,
  ],
  [
    "Better user experience",
    "Give users clear, responsive, and task-focused interfaces across devices.",
    Users,
  ],
  [
    "Scalable digital growth",
    "Build on architecture that can evolve instead of being replaced after launch.",
    ArrowUpRight,
  ],
];
...
const standards = [
  [
    ...
    "Permissions, validation, clean boundaries, and a codebase that remains understandable as the product grows.",
    LockKeyhole,
    "SECURITY · ARCHITECTURE",
  ],
  [
    "Responsive and performant",
    "Core workflows are designed for desktop, tablet, and mobile, with deliberate loading and asset behavior.",
    Gauge,
    "EXPERIENCE · PERFORMANCE",
  ],
  [
    "Tested and supportable",
    "Critical flows are reviewed before release, with practical documentation, handover, and post-launch support.",
    CheckCircle2,
    "QUALITY · HANDOVER",
  ],
];
...
const technologyGroups = [
  ...
  {
    label: "Mobile",
    items: ["Flutter", "Android", "Cross-platform"],
    icon: Smartphone,
  },
  {
    label: "Backend",
  ...
  {
    label: "Cloud",
    items: ["Vercel", "Cloudflare", "Secure deployment"],
    icon: Cloud,
  },
  {
    label: "Product",
    items: ["Figma", "Design systems", "QA & handover"],
    icon: Boxes,
  },
];
...
const industries = [
  [
    "Education",
    "Academic platforms, portals, materials, results, and administration.",
    GraduationCap,
  ],
  [
    "Islamic Technology",
  ...
  [
    "E-commerce",
    "Product discovery, ordering, management, and operational systems.",
    ShoppingBag,
  ],
  [
    "Healthcare & Services",
    "Structured digital experiences for appointments, records, and service delivery.",
    HeartPulse,
  ],
  [
    "Startups & Product Teams",
    "MVPs, scalable product foundations, and iterative feature delivery.",
    Rocket,
  ],
];
...
const faqs = [
  [
    ...
    "A clear description of the problem, current workflow, target users, and any deadline or operational constraint. We can help structure the scope from there.",
  ],
  [
    "How are timeline and budget estimated?",
    "They are based on scope, integrations, design depth, delivery risk, and support requirements—not a generic package price.",
  ],
  [
    "Can you improve an existing system?",
    "Yes. We can audit an existing codebase, stabilize critical flows, redesign selected parts, or plan a controlled rebuild.",
  ],
  [
    "Who owns the source code and product?",
    "Ownership is defined before work starts. For client projects, handover and repository access are included according to the agreed scope.",
  ],
  [
    "Do you provide maintenance after launch?",
    "Yes. Support can include monitoring, bug fixes, controlled improvements, deployment help, and ongoing product work.",
  ],
  [
    "Can you work under an NDA?",
    "Yes. Confidential workflows, product details, and business information can be covered by an NDA before technical discovery.",
  ],
];
...
const founders = [
  {
    ...
    summary:
      "Product strategy, system architecture, backend engineering, and technical leadership.",
  },
  {
    ...
    summary:
      "Engineering execution, responsive delivery, product implementation, and release coordination.",
  },
  {
    ...
    summary:
      "Full-stack implementation, frontend systems, testing, and delivery quality.",
  },
];
        ...
        <div className="dashboard-content">
          ...
          <div className="chart-card">
            ...
            <svg viewBox="0 0 480 120" aria-hidden="true">
              <path
                d="M0 100 C45 92, 55 62, 92 72 S150 96, 188 50 S250 70, 294 38 S360 52, 406 22 S450 26, 480 10"
                fill="none"
                stroke="currentColor"
                strokeWidth="3"
              />
              <path
                d="M0 100 C45 92, 55 62, 92 72 S150 96, 188 50 S250 70, 294 38 S360 52, 406 22 S450 26, 480 10 L480 120 L0 120 Z"
                fill="url(#chartFill)"
                opacity=".25"
              />
              <defs>
      ...
      <div className="hero-depth-layer hero-depth-mobile">
        ...
        >
          <div className="module-label">
            <Smartphone size={15} /> MOBILE PRODUCT
          </div>
          <Image
            src="/images/amal/today_dashboard_prayer_times.jpeg"
            alt="Islamic Amal Tracker mobile interface"
            width={210}
            height={420}
          />
        </motion.div>
...
export default function HomeExperience() {
  ...
  const heroAtmosphereShift = useTransform(
    smoothHeroProgress,
    [0, 1],
    [0, 130],
  );
        ...
        <div className="home-shell hero-grid">
          <motion.div
            ...
            style={
              prefersReducedMotion
                ? undefined
                : { "--hero-copy-shift": heroCopyShift }
            }
          >
            <div className="eyebrow">
              <span /> CUSTOM SOFTWARE SYSTEMS
            </div>
            <h1>
              <span>We turn complex workflows</span>
              <span>into simple digital systems.</span>
            </h1>
            <p>
              Custom platforms, mobile products, automation, and AI—designed as
              one connected solution around how your business actually works.
            </p>
            ...
            <div className="hero-proof">
              ...
              <span>Business-first planning</span>
              <div className="proof-mark">
                <Check size={15} />
              </div>
              <span>Scalable engineering</span>
              <div className="proof-mark">
                <Check size={15} />
              </div>
          ...
          <motion.div
            ...
            style={
              prefersReducedMotion
                ? undefined
                : { "--hero-scene-shift": heroSceneShift }
            }
          >
            <MotionBoundary className="hero-spatial-boundary" strict={false}>
              <TiltSurface
                className="hero-spatial-surface"
                maxTilt={4.5}
                perspective={1500}
              >
                <SystemHeroVisual />
        ...
        <div className="home-shell client-trust-inner">
          ...
          >
            ...
            <h2 id="client-trust-title">
              Software already built for real users and operational teams.
            </h2>
            <p>
              A mix of Effy Tech-owned products and delivered client or
              institutional platforms—each designed and engineered for active
              use.
            </p>
            <div
              className="client-trust-assurance"
              aria-label="Delivery principles"
            >
              <span>
                <CheckCircle2 size={15} /> Clear product ownership
              </span>
              <span>
                <ShieldCheck size={15} /> Production-minded engineering
              </span>
            </div>
            <div
              className="client-proof-count"
              aria-label={`${clientProof.length} selected systems`}
            >
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="client-logo-media">
                        ...
                        />
                        <span className="client-card-status">
                          <i /> REAL-WORLD SYSTEM
                        </span>
                      ...
                      <div className="client-logo-content">
                        ...
                        <dl className="client-proof-meta">
                          ...
                          <div>
                            <dt>Use case</dt>
                            <dd>{client.audience}</dd>
                          </div>
                        </dl>
                        <em>{client.tech}</em>
                        <span className="client-project-link">
      ...
      <section id="services" className="capability-section">
        <div className="home-shell">
          <motion.div className="section-intro section-intro-inverse" {...fade}>
            ...
            <h2>
              Capabilities designed to work <em>as one.</em>
            </h2>
            <p>
              Not isolated services. A connected product system—from interface
              to infrastructure, workflow, and intelligence.
            </p>
          </motion.div>
          <div className="capability-system">
            ...
            <div className="capability-connectors" aria-hidden="true">
              <i />
              <i />
              <i />
              <i />
            ...
            <div className="capability-orbit">
              {capabilities.map(
                (
                  ...
                  <motion.article
                    className={`capability-node capability-node-${index + 1}`}
                    key={title}
                    {...fade}
                  >
      ...
      <section id="work" className="work-section">
        <div className="home-shell">
          ...
          <motion.article className="iam-case" {...fade}>
            <div className="case-copy">
              ...
              <div className="case-brand">
                <Image
                  ...
                  height={52}
                />
                <p>Islamic Amal Tracker</p>
              </div>
              <h3>
                A complete offline-first system for building consistency in
                daily worship.
              </h3>
              <p>
                Prayer, Kaza, Amal, Dhikr, reading, routines, reminders,
                statistics, widgets, and cloud sync—engineered as one cohesive
                mobile product.
              </p>
              <ul>
                <li>
                  <Check size={16} /> Offline-first Flutter architecture
                </li>
                <li>
                  <Check size={16} /> Structured tracking and smart reminders
                </li>
                <li>
                  <Check size={16} /> Detailed progress and consistency insights
                </li>
              </ul>
              <Link
            ...
            <div className="case-visual">
              <MotionBoundary className="case-spatial-boundary">
                <TiltSurface
                  className="case-spatial-surface"
                  maxTilt={2.5}
                  perspective={1200}
                >
                  ...
                  <div className="phone phone-main">
                    <Image
                      src="/images/amal/today_dashboard_prayer_times.jpeg"
                      alt="Islamic Amal Tracker dashboard"
                      fill
                      sizes="260px"
                    />
                  </div>
                  <div className="phone phone-left">
                    <Image
                      ...
                      alt="Islamic Amal Tracker statistics"
                      fill
                      sizes="220px"
                    />
                  </div>
                  <div className="phone phone-right">
                    <Image
                      ...
                      alt="Islamic Amal Tracker dhikr screen"
                      fill
                      sizes="220px"
                    />
                  </div>
          ...
          <div className="secondary-projects editorial-projects">
            <motion.article
              className="project-feature project-feature-eems"
              {...fade}
            >
              <BrowserMockup
                className="project-screen project-browser"
                label="Effy Edu Management System preview"
                title="shifatstales.com"
              >
                <Image
                  src="/images/effy-edu-management-system/case-study/hero.webp"
                  alt="Effy Edu coaching management system"
                  fill
                  sizes="(max-width: 768px) 100vw, 60vw"
                />
              </BrowserMockup>
              <div className="project-copy">
                <span>COACHING MANAGEMENT · 02</span>
                <h3>Effy Edu Management System</h3>
                <p>
                  <b>Problem:</b> Public content, student services, and
                  recurring coaching operations were split across disconnected
                  processes.
                </p>
                <p>
                  <b>Solution:</b> One role-based platform with a public
                  website, student portal, teacher/admin console, academic
                  workflows, reporting, payments, and CMS.
                </p>
                <ul>
                  <li>Status: Live client platform</li>
                  <li>Stack: Next.js · TypeScript</li>
                  <li>Outcome: Connected education operations</li>
                </ul>
                <div className="flex flex-wrap gap-4">
                  <Link href="/projects/effy-edu-management-system">
                    Open case study <ArrowRight size={15} />
                  </Link>
                  <a
                    href="/demos/effy-edu-management-system"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Interactive demo <ArrowUpRight size={15} />
                  </a>
                </div>
              </div>
            </motion.article>
            <motion.article
              className="project-feature project-feature-dha"
              {...fade}
            >
              <BrowserMockup
                className="project-screen project-browser"
                label="Darul Hikmah Academy website preview"
                title="darulhikmah.academy"
              >
                <Image
                  src="/images/dha/case-study/hero.webp"
                  alt="Darul Hikmah Academy website"
                  fill
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
              </BrowserMockup>
              <div className="project-copy">
                <span>EDUCATION PLATFORM · 03</span>
                <h3>Darul Hikmah Academy</h3>
                <p>
                  <b>Problem:</b> Academic information and public content needed
                  one structured, maintainable platform.
                </p>
                <p>
                  <b>Solution:</b> A bilingual website with dynamic
                  administration, course discovery, materials, and responsive
                  public access.
                </p>
                <ul>
                  <li>Status: Production platform</li>
                  <li>Stack: Next.js · Supabase</li>
                  <li>Outcome: Centralized content management</li>
                </ul>
                <Link href="/projects/darul-hikmah-academy">
                  Open case study <ArrowRight size={15} />
                </Link>
              </div>
            </motion.article>
            <motion.article
              className="project-feature project-feature-buek"
              {...fade}
            >
              <BrowserMockup
                className="project-screen project-browser"
                label="BUEK university website preview"
                title="buek.edu.bd"
              >
                <Image
                  src="/images/buek/case-study/hero.webp"
                  alt="BUEK university website"
                  fill
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
              </BrowserMockup>
              <div className="project-copy">
                <span>INSTITUTIONAL PLATFORM · 04</span>
                <h3>BUEK</h3>
                <p>
                  <b>Problem:</b> Notices, events, media, and academic
                  information needed a reliable publishing workflow.
                </p>
                <p>
                  <b>Solution:</b> A structured university platform with
                  admin-controlled content and fast public access.
                </p>
                <ul>
                  <li>Status: Production platform</li>
                  <li>Stack: Next.js · Admin CMS</li>
                  <li>Outcome: Organized institutional publishing</li>
                </ul>
                <Link href="/projects/bangladesh-university-of-excellence-khulna">
                  Open case study <ArrowRight size={15} />
                </Link>
              </div>
            </motion.article>
      ...
      <section id="outcomes" className="outcomes-section">
        <div className="home-shell">
          <motion.div className="section-intro" {...fade}>
            ...
            <h2>
              Built to create operational value, not just another interface.
            </h2>
            <p>
              Every project is shaped around a concrete improvement in how the
              organization works, serves users, or grows.
            </p>
          </motion.div>
      ...
      <section id="process" className="process-section">
        <div className="home-shell process-grid">
          <motion.div className="section-intro" {...fade}>
            ...
            <h2>A clear path from complexity to launch.</h2>
          </motion.div>
          <div className="process-journey">
            <div className="process-spine" aria-hidden="true" />
            {process.map(({ n, title, text, icon: Icon }, index) => (
              <motion.article
                key={title}
                className="process-step process-step-spatial"
                {...fade}
              >
      ...
      <section id="standards" className="standards-section">
        <div className="home-shell standards-layout">
          <motion.div className="standards-heading" {...fade}>
            ...
            <p>
              We combine business-first planning, secure architecture,
              performance, testing, documentation, direct communication, and
              post-launch support in one delivery standard.
            </p>
          </motion.div>
          <div className="standards-grid">
            {standards.map(([title, text, Icon, label], index) => (
              <motion.article
                className="standards-card-spatial"
                key={title}
                {...fade}
              >
      ...
      <section id="technology" className="technology-section">
        <div className="home-shell">
          <motion.div className="section-intro" {...fade}>
            ...
            <p>
              We choose the stack around product requirements, operational
              constraints, maintainability, and the team that will own the
          ...
          <div className="technology-grid">
            {technologyGroups.map(({ label, items, icon: Icon }, index) => (
              <motion.article
                className="technology-card-spatial"
                key={label}
                {...fade}
              >
      ...
      <section id="about" className="about-industries-section">
        <div className="home-shell about-industries-layout">
          <motion.div className="about-company" {...fade}>
            ...
            <h2>
              A software company focused on practical systems that stay useful.
            </h2>
            <p>
              Effy Tech plans, designs, engineers, deploys, and supports digital
              products for businesses, institutions, and product teams. We stay
              close to the workflow, communicate directly, and build with
            ...
            <div className="about-company-points">
              <div>
                ...
                <span>
                  The people planning the work remain involved in delivery.
                </span>
              </div>
              <div>
                <strong>End-to-end execution</strong>
                <span>
                  Product thinking, interface design, engineering, deployment,
                  and support.
                </span>
              </div>
            </div>
          ...
          <div className="industries-panel">
            <div className="industries-heading">
              ...
              <h3>Relevant experience across focused industries.</h3>
            </div>
      ...
      <section id="team" className="team-section">
        <div className="home-shell">
          <motion.div className="section-intro" {...fade}>
            ...
            <h2>Built by people who stay close to the work.</h2>
          </motion.div>
          <div className="founder-stage">
            <div className="founder-statement">
              <span>ENGINEERING-LED. PRODUCT-FOCUSED.</span>
              <p>
                Small team, direct ownership, and no distance between the people
      ...
      <section id="faq" className="faq-section">
        <div className="home-shell faq-layout">
          <motion.div className="faq-heading" {...fade}>
            ...
            <p>
              Clear expectations reduce delivery risk. These are the questions
              clients usually need answered first.
            </p>
          </motion.div>
      ...
      <section id="contact" className="contact-section">
        <div className="home-shell contact-layout">
          <motion.div className="contact-copy" {...fade}>
            ...
            <p>
              Share the problem, the current process, and the result you need.
              We will help define the practical product and technical direction.
            </p>
            ...
            <div className="contact-details">
              <a href="mailto:effytechbd@gmail.com">
                <Mail size={19} />
                <div>
              ...
              <div>
                ...
                <div>
                  ...
                  <strong>Shyamoli, Dhaka, Bangladesh</strong>
                </div>
              </div>
            </div>
            <div className="contact-response">
              <CheckCircle2 size={17} /> Usually responds within one business
              day.
            </div>
          </motion.div>
