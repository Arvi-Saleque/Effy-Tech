...
function trackIamCta(buttonName, position, destination) {
  trackCTAClick(buttonName, {
    page_name: "IAM",
    page_location: "/projects/islamic-amal-tracker",
...
function FeatureDeepDive({ categories }) {
  ...
  const activeIndex = Math.max(
    0,
    categories.findIndex((item) => item.id === activeId),
  );
        ...
        >
          <div>
            ...
            <h2 className="mt-3 text-4xl font-black leading-[1.02] tracking-[-0.045em] text-[var(--iam-ink)] sm:text-6xl">
              Feature বেছে নিন।
              <br />
              বাস্তব workflow দেখুন।
            </h2>
          </div>
          <p className="max-w-2xl text-base leading-8 text-[var(--iam-copy)] sm:text-lg">
            গুরুত্বপূর্ণ আটটি module কীভাবে দৈনিক tracking সহজ করে—বাস্তব
            interface, focused workflow এবং পরিষ্কার ব্যাখ্যাসহ দেখুন।
          </p>
        </motion.div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <span
                        className={`mt-1 block truncate text-[9px] font-black uppercase tracking-[0.13em] ${selected ? "text-[#d8c9a4]" : "text-[#727867]"}`}
                      >
                        {item.titleEn}
                      </span>
                    </div>
                    <span
                      className={`text-[9px] font-mono ${selected ? "text-white/40" : "text-black/25"}`}
                    >
                ...
                <div className="relative z-10 flex h-full flex-col">
                  ...
                  <div className="mt-7 grid gap-3">
                    {active?.points.map((point, index) => (
                      <div
                        key={point}
                        className="flex gap-3 rounded-[1rem] border border-white/10 bg-white/[0.045] p-4"
                      >
                        <span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-[#727867]/35 text-[10px] font-black text-[#dfcf9b]">
                          {index + 1}
                        </span>
                        <p className="text-sm font-medium leading-6 text-[#e4e6df]">
                          {point}
                        </p>
                      </div>
                    ))}
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      Array.from(originals.keys()).forEach((element) => {
        if (!launchers.has(element) || !isMobile || !heroVisible)
          restore(element);
      });
    };
...
export default function AmalTrackerShowcase({ data }) {
  ...
  return (
    <main className="effy-project-page effy-project-page--iam min-h-screen overflow-x-hidden">
      ...
      >
        <div
          className="iam-hero-geometry pointer-events-none absolute inset-0"
          aria-hidden="true"
        >
          ...
          >
            <motion.div variants={fadeUp} className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm font-black text-[var(--iam-ink)]">
                  Designed & engineered by Effy Tech
                </p>
              </div>
            </motion.div>
            ...
            <motion.p
              variants={fadeUp}
              className="mt-8 text-xs font-black uppercase tracking-[0.24em] text-[#aa9158]"
            >
              {nameBn}
            </motion.p>
            <motion.h1
            ...
            >
              আপনার দৈনিক ইবাদত
              <br />
              একটি focused system-এ।
            </motion.h1>
            <motion.p
              variants={fadeUp}
              className="mt-5 text-xl font-black text-[#727867]"
            >
              {tagline}
            </motion.p>
            <motion.p
              variants={fadeUp}
              className="project-hero-copy mt-5 max-w-xl text-base leading-8 text-[var(--iam-copy)] sm:text-lg"
            >
              {descriptionBn}
            </motion.p>
            ...
            >
              <a
                ...
                onClick={() =>
                  trackIamCta("Install - Hero", "hero", "google_play")
                }
            ...
            <motion.div
              variants={fadeUp}
              className="mt-7 flex flex-wrap gap-x-5 gap-y-3 text-xs font-bold text-[#626a60]"
            >
              <span className="flex items-center gap-1.5">
                <HiCheckCircle className="h-4 w-4 text-[#aa9158]" />
                বিজ্ঞাপনমুক্ত
              </span>
              <span className="flex items-center gap-1.5">
                <HiCheckCircle className="h-4 w-4 text-[#aa9158]" />
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 transition hover:text-[var(--iam-ink)]"
              >
                <FaShieldAlt className="h-3.5 w-3.5 text-[#aa9158]" />
                Privacy Policy
              </a>
              <a
                href={supportUrl}
                ...
                rel="noopener noreferrer"
                onClick={() =>
                  trackIamCta("Support - Hero", "hero", "whatsapp_support")
                }
                className="flex items-center gap-1.5 transition hover:text-[var(--iam-ink)]"
              >
                <FaWhatsapp className="h-4 w-4 text-[#aa9158]" />
                WhatsApp Support
              </a>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="mb-5 flex items-center justify-between px-1">
              <div>
                ...
                <p className="mt-1 text-sm font-black text-[var(--iam-ink)]">
                  ২১টি complete screen explore করুন
                </p>
              </div>
              <span className="hidden rounded-full border border-black/10 bg-white/60 px-3 py-1.5 text-[10px] font-black text-[#727867] sm:inline">
                Swipe · Scroll
              </span>
            </div>
            <MotionBoundary className="iam-hero-motion" strict={false}>
              <TiltSurface
                className="iam-hero-tilt"
                maxTilt={2.2}
                perspective={1250}
              >
        ...
        <div className="relative z-10 mx-auto mt-16 max-w-7xl px-5 sm:px-8 lg:px-10">
          ...
          >
            {socialProof.map((item, index) => (
              <div
                key={item.label}
                className={`p-5 text-center sm:p-6 ${index > 0 ? "border-t border-black/[0.08] sm:border-l sm:border-t-0" : ""}`}
              >
                <div className="flex items-center justify-center gap-2">
                  {index === 1 && <FaStar className="h-4 w-4 text-[#aa9158]" />}
                  <strong className="text-2xl font-black text-[var(--iam-ink)] sm:text-3xl">
                    {item.value}
                  </strong>
                </div>
                <span className="mt-1 block text-[10px] font-black uppercase tracking-[0.16em] text-[#727867]">
                  {item.label}
                </span>
              </div>
            ))}
      ...
      <Section className="iam-highlights relative mx-auto max-w-7xl px-6 py-16 sm:px-10 sm:py-20">
        <div className="grid gap-4 md:grid-cols-3">
          {[
            {
              icon: FaMobileAlt,
              title: "Daily use first",
              copy: "দ্রুত logging, পরিষ্কার hierarchy এবং প্রয়োজনীয় তথ্য এক জায়গায়।",
            },
            {
              icon: FaShieldAlt,
              title: "Offline-first reliability",
              copy: "Internet ছাড়াই core tracking; প্রয়োজন হলে optional cloud backup ও sync।",
            },
            {
              icon: FaChartLine,
              title: "Progress you can understand",
              copy: "Daily, weekly ও monthly insights থেকে নিজের consistency ও gap বুঝুন।",
            },
          ].map((item, index) => (
            <motion.div
              key={item.title}
              variants={fadeUp}
              custom={index}
              className="iam-highlight-card rounded-[1.25rem] border border-black/[0.07] bg-[var(--iam-ink)] p-6 text-[#fbf8ef] shadow-[0_14px_34px_rgba(34,39,31,0.11)]"
            >
              <div className="flex items-center justify-between">
                <span className="grid h-12 w-12 place-items-center rounded-[0.9rem] border border-white/10 bg-white/[0.06] text-[#d8c9a4]">
              ...
              <p className="mt-3 text-sm leading-6 text-[#cfd4cb]">
                {item.copy}
              </p>
            </motion.div>
          ))}
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-10">
          <div className="mb-12 grid gap-5 lg:grid-cols-[0.82fr_1.18fr] lg:items-end lg:gap-16">
            <div>
              <motion.p
                variants={fadeUp}
                className="text-[11px] font-black uppercase tracking-[0.26em] text-[#d8c9a4]"
              >
                Core capabilities
              </motion.p>
              <motion.h2
                variants={fadeUp}
                className="mt-3 text-4xl font-black leading-[1.02] tracking-[-0.045em] text-[#fbf8ef] sm:text-6xl"
              >
                দৈনিক ব্যবহারের জন্য
                <br />
                সবচেয়ে গুরুত্বপূর্ণ আটটি feature।
              </motion.h2>
            </div>
            <motion.p
              variants={fadeUp}
              className="max-w-2xl text-base leading-8 text-[#d2d6ce] sm:text-lg"
            >
              Feature count বাড়ানোর জন্য নয়—নিয়মিত tracking, accountability এবং
              meaningful improvement সহজ করার জন্য প্রতিটি module তৈরি।
            </motion.p>
          </div>
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.article
                  ...
                  variants={fadeUp}
                  custom={index}
                  className="group rounded-[1.2rem] border border-white/[0.09] bg-white/[0.035] p-5 transition hover:-translate-y-1 hover:bg-white/[0.055] sm:p-6"
                >
                  <div className="flex items-center justify-between">
                    <span className="grid h-11 w-11 place-items-center rounded-[0.8rem] border border-white/10 bg-[#2c332b] text-[#d8c9a4]">
                  ...
                  <h3 className="mt-7 text-xl font-black text-[#fbf8ef]">
                    {feature.titleBn}
                  </h3>
                  <p className="mt-2 text-[9px] font-black uppercase tracking-[0.15em] text-[#d8c9a4]">
                    {feature.titleEn}
                  </p>
                  <p className="mt-4 text-sm leading-6 text-[#cfd4cb]">
                    {feature.descBn}
                  </p>
                </motion.article>
              );
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-10">
          <div className="mb-12 grid gap-5 lg:grid-cols-[0.8fr_1.2fr] lg:items-end lg:gap-16">
            <div>
              <motion.p
                variants={fadeUp}
                className="text-[11px] font-black uppercase tracking-[0.26em] text-[#727867]"
              >
                How it works
              </motion.p>
              <motion.h2
                variants={fadeUp}
                className="mt-3 text-4xl font-black leading-[1.03] tracking-[-0.045em] text-[var(--iam-ink)] sm:text-5xl"
              >
                শুরু করা সহজ।
                <br />
                ধারাবাহিক থাকা আরও সহজ।
              </motion.h2>
            </div>
            <motion.p
              variants={fadeUp}
              className="max-w-2xl text-base leading-8 text-[var(--iam-copy)] sm:text-lg"
            >
              App install করুন, নিজের tracking সাজান এবং প্রতিদিনের অগ্রগতি একটি
              পরিচিত flow-এর মধ্যে অনুসরণ করুন।
            </motion.p>
          </div>
          ...
          <div className="iam-steps grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {howItWorks.map((step, index) => (
              <motion.article
                ...
                variants={fadeUp}
                custom={index}
                className="rounded-[1.2rem] border border-black/[0.08] bg-white/55 p-5 shadow-[0_10px_28px_rgba(34,39,31,0.045)] sm:p-6"
              >
                <div className="flex items-center justify-between">
                  <span className="grid h-12 w-12 place-items-center rounded-[0.8rem] border border-[#aa9158]/20 bg-[#aa9158]/10 text-lg font-black text-[var(--iam-ink)]">
                    {step.step}
                  </span>
                  <span className="text-[9px] font-black uppercase tracking-[0.16em] text-black/30">
                    Step {String(index + 1).padStart(2, "0")}
                  </span>
                </div>
                <h3 className="mt-8 text-xl font-black text-[var(--iam-ink)]">
                  {step.titleBn}
                </h3>
                <p className="mt-2 text-[9px] font-black uppercase tracking-[0.14em] text-[#727867]">
                  {step.titleEn}
                </p>
                <p className="mt-4 text-sm leading-6 text-[var(--iam-copy)]">
                  {step.descBn}
                </p>
              </motion.article>
            ))}
          ...
          >
            <div className="grid lg:grid-cols-[0.78fr_1.22fr]">
              <div className="border-b border-white/10 p-7 sm:p-10 lg:border-b-0 lg:border-r">
                <p className="text-[11px] font-black uppercase tracking-[0.25em] text-[#d8c9a4]">
                  Effy Tech product engineering
                </p>
                <h2 className="mt-4 text-4xl font-black leading-[1.03] tracking-[-0.045em] sm:text-5xl">
                  শুধু একটি app নয়।
                  <br />
                  একটি complete product case study।
                </h2>
                <p className="mt-5 text-base leading-8 text-[#cfd4cb]">
                  Islamic Amal Tracker দেখায় Effy Tech কীভাবে real workflow বুঝে
                  product plan, interface design, mobile engineering, backend,
                  native integration এবং production release একসঙ্গে পরিচালনা
                  করে।
                </p>
                <div className="mt-7 flex flex-wrap gap-2">
                  {techStack.map((item) => (
                    <span
                      key={item}
                      className="rounded-full border border-white/10 bg-white/[0.045] px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.12em] text-white/65"
                    >
                      {item}
                    </span>
                  ))}
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
                  ...
                  <Link
                    ...
                    onClick={() =>
                      trackIamCta(
                        "Start Project - Engineering",
                        "engineering",
                        "contact_page",
                      )
                    }
                    className="inline-flex min-h-14 items-center justify-center gap-2 rounded-[0.9rem] border border-white/15 px-5 font-black text-[#fbf8ef] transition hover:bg-white/[0.05]"
                  >
                    Start a Project
                    <HiArrowRight className="h-4 w-4" />
                  </Link>
              ...
              <div className="grid gap-px bg-white/10 sm:grid-cols-2">
                {engineeringHighlights.map((item) => (
                  <article
                    key={item.number}
                    className="bg-[var(--iam-ink)] p-6 sm:p-8"
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] font-mono text-[#d8c9a4]">
                        {item.number}
                      </span>
                      {item.number === "01" ? (
                        <FaShieldAlt className="h-4 w-4 text-white/30" />
                      ) : item.number === "02" ? (
                        <FaMobileAlt className="h-4 w-4 text-white/30" />
                      ) : item.number === "03" ? (
                        <FaCode className="h-4 w-4 text-white/30" />
                      ) : (
                        <FaCheckCircle className="h-4 w-4 text-white/30" />
                      )}
                    </div>
                    <h3 className="mt-8 text-xl font-black">{item.title}</h3>
                    <p className="mt-3 text-sm leading-6 text-[#bfc7bf]">
                      {item.copy}
                    </p>
                  </article>
                ))}
      ...
      <Section className="iam-trust relative overflow-hidden py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-6 sm:px-10">
          <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
            <motion.div
              variants={fadeUp}
              className="rounded-[1.4rem] border border-black/[0.08] bg-white/55 p-6 sm:p-8"
            >
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#727867]">
                Transparent and supportable
              </p>
              <h2 className="mt-3 text-3xl font-black tracking-[-0.035em] text-[var(--iam-ink)]">
                আপনার data, privacy এবং support—সবকিছুর পরিষ্কার পথ আছে।
              </h2>
              <p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--iam-copy)]">
                Privacy Policy থেকে data handling পড়ুন, আর app ব্যবহার বা
                technical সমস্যায় সরাসরি WhatsApp support নিন।
              </p>
            </motion.div>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
              <motion.a
                ...
                rel="noopener noreferrer"
                onClick={() =>
                  trackIamCta("Privacy Policy", "trust", "privacy_policy")
                }
                className="flex items-center justify-between rounded-[1.2rem] border border-black/[0.08] bg-white/55 p-5 transition hover:bg-white"
              >
                <span className="flex items-center gap-3">
                  <span className="grid h-10 w-10 place-items-center rounded-[0.7rem] bg-[#ebe6da] text-[#727867]">
                    <FaShieldAlt className="h-4 w-4" />
                  </span>
                  <span>
                    <strong className="block text-sm text-[var(--iam-ink)]">
                      Privacy Policy
                    </strong>
                    <small className="mt-1 block text-[#727867]">
                      Data handling ও controls
                    </small>
                  </span>
                </span>
              ...
              <motion.a
                ...
                rel="noopener noreferrer"
                onClick={() =>
                  trackIamCta("WhatsApp Support", "trust", "whatsapp_support")
                }
                className="flex items-center justify-between rounded-[1.2rem] border border-black/[0.08] bg-white/55 p-5 transition hover:bg-white"
              >
                <span className="flex items-center gap-3">
      ...
      <Section
        id="faq"
        className="iam-faq relative overflow-hidden py-20 sm:py-28"
      >
        <div className="mx-auto max-w-5xl px-6 sm:px-10">
          <div className="mx-auto mb-10 max-w-2xl text-center">
            <motion.p
              variants={fadeUp}
              className="text-[11px] font-black uppercase tracking-[0.25em] text-[#727867]"
            >
              Frequently asked questions
            </motion.p>
            <motion.h2
              variants={fadeUp}
              className="mt-3 text-4xl font-black tracking-[-0.045em] text-[var(--iam-ink)] sm:text-5xl"
            >
              Install করার আগে যা জানা দরকার।
            </motion.h2>
          </div>
          <div className="grid gap-3">
            {faqs.map((item, index) => (
              <motion.details
                ...
                variants={fadeUp}
                custom={index}
                className="group rounded-[1rem] border border-black/[0.08] bg-white/55 px-5 py-1 open:bg-white sm:px-6"
              >
                <summary className="flex cursor-pointer list-none items-center justify-between gap-4 py-5 text-left text-base font-black text-[var(--iam-ink)] sm:text-lg">
                  {item.question}
                  <span className="grid h-8 w-8 shrink-0 place-items-center rounded-full border border-black/10 text-[#727867] transition group-open:rotate-180">
                    <HiChevronDown className="h-4 w-4" />
                  </span>
                </summary>
                <p className="border-t border-black/[0.07] pb-5 pt-4 text-sm leading-7 text-[var(--iam-copy)]">
                  {item.answer}
                </p>
              </motion.details>
            ))}
          ...
          >
            <div className="p-7 sm:p-12">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm font-black text-[var(--iam-copy)]">
                    1500+ installs · 4.77/5 rating
                  </p>
                </div>
              </div>
              <h2 className="mt-8 text-4xl font-black leading-[1.02] tracking-[-0.05em] text-[var(--iam-ink)] sm:text-6xl">
                আজ থেকেই ধারাবাহিকতা গড়ে তুলুন।
              </h2>
              <p className="mt-5 max-w-2xl text-base leading-8 text-[var(--iam-copy)] sm:text-lg">
                Islamic Amal Tracker install করুন এবং নামাজ, আমল, যিকির,
                Routine, Dua ও progress—সবকিছু একটি focused system-এ গুছিয়ে নিন।
              </p>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  ...
                  className="inline-flex min-h-16 items-center justify-center gap-3 rounded-[0.95rem] bg-[var(--iam-ink)] px-8 py-4 font-black text-[#fbf8ef] transition hover:-translate-y-0.5"
                >
                  <FaGooglePlay className="h-6 w-6" />
                  <span className="text-left">
                    <span className="block text-[9px] uppercase tracking-[0.13em] text-white/55">
                      Get it on
                    </span>
                    <span className="block text-lg leading-tight">
                      Google Play
                ...
                <a
                  ...
                  className="inline-flex min-h-16 items-center justify-center gap-2 rounded-[0.95rem] border border-black/10 px-7 py-4 text-sm font-black text-[var(--iam-ink)] transition hover:bg-white"
                >
                  <FaWhatsapp className="h-5 w-5" />
                  এমন একটি app বানাতে কথা বলুন
                </a>
            ...
            <div className="relative hidden min-h-[360px] items-center justify-center bg-[var(--iam-ink)] p-8 text-center lg:flex">
              <div className="rounded-[1.4rem] border border-white/10 bg-white/[0.05] p-6">
                <Image
                  src="/images/amal/play-store-qr.png"
                  alt="Scan to install Islamic Amal Tracker"
                  width={176}
                  height={176}
                  className="mx-auto h-44 w-44 rounded-[0.75rem] bg-white p-2"
                />
                <p className="mt-5 text-lg font-black text-white">
                  Scan to install
                </p>
                <p className="mt-2 max-w-[240px] text-sm leading-6 text-[#aeb8af]">
                  Phone camera দিয়ে QR code scan করে সরাসরি Google Play page
                  খুলুন।
                </p>
              </div>
            </div>
