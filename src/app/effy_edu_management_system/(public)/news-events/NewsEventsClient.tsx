...
import InnerPageHero from "@/features/effy-edu-demo/components/layout/InnerPageHero";
      ...
      <div className="brand-container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-14 relative z-10">
        ...
        <InnerPageHero
          ...
          description={
            ...
            "Stay informed with upcoming admission workshops, scholarship model tests, revision schedules, and student success celebrations at EduPilot Coaching Academy."
          }
        breadcrumbs={[{ label: "Home", href: "/effy_edu_management_system" }, { label: "News & Events" }]}
          imageSrc={heroData?.mediaUrl || "/effy_edu_management_system/images/gallery-event.png"}
        />
          ...
          <div className="relative bg-white dark:bg-slate-900 border-2 border-accent/40 rounded-3xl p-6 sm:p-8 lg:p-10 shadow-xl overflow-hidden group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
              ...
              <div className="lg:col-span-5 relative h-64 sm:h-72 rounded-2xl overflow-hidden shadow-md border border-border/40">
                <Image
                  src={featuredItem.imageUrl || "/effy_edu_management_system/images/flyer_hsc26_hsc27.jpg"}
              ...
              <div className="lg:col-span-7 space-y-4 text-left">
                ...
                <Link href={`/effy_edu_management_system/news-events/${featuredItem.id}`} className="block">
                ...
                <div className="pt-3 flex flex-wrap items-center gap-3">
                  <Link
                    href={`/effy_edu_management_system/news-events/${featuredItem.id}`}
          ...
          {filteredItems.map((item) => (
            ...
            >
              ...
              <div className="relative h-48 w-full bg-slate-100 dark:bg-slate-800 overflow-hidden shrink-0">
                <Image
                  src={item.imageUrl || "/effy_edu_management_system/images/gallery-event.png"}
                  alt={item.title}
                  fill
              ...
              <div className="p-6 flex flex-col flex-1 justify-between space-y-4">
                <div className="space-y-2.5">
                  ...
                  <Link href={`/effy_edu_management_system/news-events/${item.id}`} className="block">
                ...
                <div className="pt-4 border-t border-border/40 flex items-center justify-between">
                  <Link
                    href={`/effy_edu_management_system/news-events/${item.id}`}
