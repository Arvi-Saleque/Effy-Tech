...
export const defaultCuratedItems: NewsEventItem[] = [
  {
    ...
    location: "EduPilot Coaching Academy Campus, 3rd Floor, Dhaka, Dhaka",
    excerpt:
    ...
    fullContent: [
      "Join Lead Instructor for an inspiring 3-hour orientation session designed specifically for HSC 2026 and 2027 science aspirants.",
      ...
      "All attendees will receive Lead Instructor's exclusive Formula Booklet free of cost. Seats are limited to 80 students due to venue capacity.",
    ],
    imageUrl: "/effy_edu_management_system/images/flyer_hsc26_hsc27.jpg",
    isFeatured: true,
  },
  {
    id: "not-1",
    ...
    imageUrl: "/effy_edu_management_system/images/flyer_revision_2026.jpg",
  },
  {
    id: "nws-1",
    title: "Congratulations to EduPilot Coaching Academy Top Ranking Engineering Aspirants",
    category: "NEWS",
    date: "10",
    month: "AUG",
    time: "Announcement",
    location: "EduPilot Coaching Academy Hall of Fame",
    excerpt:
    ...
    fullContent: [
      ...
      "Lead Instructor will host an exclusive Merit Award Ceremony & Dinner next month to felicitate all achievers and present them with honorary plaques.",
    ],
    imageUrl: "/effy_edu_management_system/images/gallery-solve.png",
  },
  {
    id: "evt-2",
    ...
    location: "Room 302, EduPilot Main Campus",
    excerpt:
    ...
    fullContent: [
      ...
      "Lead Instructor will walk through 25 advanced admission-level mathematical problems step-by-step without skipping intermediate calculations.",
    ...
    imageUrl: "/effy_edu_management_system/images/gallery-classroom.png",
  },
  {
    id: "not-2",
    ...
    location: "EduPilot Coaching Academy Campus, Dhaka",
    excerpt:
    ...
    imageUrl: "/effy_edu_management_system/images/flyer_model_test_2025.png",
  },
  {
    id: "nws-2",
    ...
    fullContent: [
      "EduPilot Coaching Academy announces new enrollment slots for Class 11 students wishing to build a solid academic foundation right from the beginning of their college journey.",
      "Why join our Class 11 Batches? Small batch capacity, daily lecture sheets, weekly evaluation exams, and 1-on-1 problem-solving hours directly with Lead Instructor.",
    ...
    imageUrl: "/effy_edu_management_system/images/gallery-notes.png",
  },
];
...
export function formatAllNewsEventItems(newsEventItems?: any[]): NewsEventItem[] {
  const cmsFormatted: NewsEventItem[] = (newsEventItems || []).map((item: any) => {
    ...
    return {
      ...
      location: meta.location || item.location || "EduPilot Coaching Academy Campus",
      ...
      imageUrl: item.mediaUrl || meta.imageUrl || item.imageUrl || "/effy_edu_management_system/images/gallery-event.png",
