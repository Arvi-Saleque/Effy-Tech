...
import { projectsData, ProjectItem } from "@/features/effy-edu-demo/data/about";
...
import { ProjectResources } from "@/features/effy-edu-demo/components/about/ProjectResources";
    ...
    <div className="min-h-screen bg-[#FFF9F2] pt-24 pb-16 selection:bg-accent selection:text-primary">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <nav className="flex items-center space-x-2 text-sm font-bold mb-8">
          <Link href="/effy_edu_management_system/about" className="text-primary/60 hover:text-primary transition-colors flex items-center">
            <ArrowLeft className="w-4 h-4 mr-1" />
            Back to Portfolio
          </Link>
          <span className="text-primary/30">/</span>
          <Link href="/effy_edu_management_system/about" className="text-primary/60 hover:text-primary transition-colors">
            Projects
          </Link>
          <span className="text-primary/30">/</span>
