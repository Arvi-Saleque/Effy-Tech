...
import { GalleryAlbum } from "@/features/effy-edu-demo/data/albums";
...
export default function AlbumDetailsClient({ album }: { album: GalleryAlbum }) {
  ...
  const breadcrumbs = [
    ...
    { label: "Gallery", href: "/effy_edu_management_system/gallery" },
    { label: album.title },
  ];
    ...
    <div className="min-h-screen bg-[#FFF9F2] pt-24 pb-20 relative overflow-hidden">
      ...
      <div className="mt-4 sm:mt-12">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
          <Link
            href="/effy_edu_management_system/gallery"
