...
export default function CoursesClient({ heroData, courseItems = [] }: { heroData?: any, courseItems?: any[] }) {
  ...
  return (
        ...
        <InnerPageHero
          ...
          title={
            <>
              ...
              <span className="block text-accent mt-1">{heroData?.subtitle || "EduPilot Coaching Academy"}</span>
            </>
          }
    ...
    { label: "Home", href: "/effy_edu_management_system" },
          ...
          imageSrc={heroData?.mediaUrl || "/effy_edu_management_system/images/flyer_hsc26_hsc27.jpg"}
        ...
        <motion.div layout className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-8 sm:gap-10">
          <AnimatePresence mode="popLayout">
            {filteredCourses.map((course) => {
              ...
              const bannerImage = course.mediaUrl || meta.fallbackImageUrl || "/effy_edu_management_system/images/flyer_admission_science.jpg";
