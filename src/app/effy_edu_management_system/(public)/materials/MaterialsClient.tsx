...
import PublicPdfViewer from "@/features/effy-edu-demo/components/materials/PublicPdfViewer";
...
export default function MaterialsClient({
  ...
  return (
    ...
    { label: "Home", href: "/effy_edu_management_system" },
          ...
          imageSrc={heroData?.mediaUrl || "/effy_edu_management_system/images/flyer_admission_science.jpg"}
            ...
            <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-6">
              <AnimatePresence mode="popLayout">
                {filteredItems.map((item) => {
                  ...
                  const imgUrl = item.mediaUrl || (fileType === "IMAGE" ? fileUrl : "/effy_edu_management_system/placeholder.jpg");
