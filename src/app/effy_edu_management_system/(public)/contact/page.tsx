...
import ContactSection from "@/features/effy-edu-demo/components/home/ContactSection";
import LocationSection from "@/features/effy-edu-demo/components/home/LocationSection";
import FAQSection from "@/features/effy-edu-demo/components/home/FAQSection";
import React from "react";
import { getPageSection } from "@/features/effy-edu-demo/features/website-cms/actions/content-actions";

export const metadata: Metadata = {
  title: "Contact & FAQ | EduPilot Coaching Academy",
  description: "Get in touch with EduPilot Coaching Academy Academic & Admission Care. We are here to help with your queries.",
};
...
export default async function ContactPage() {
  ...
  return (
    ...
    { label: "Home", href: "/effy_edu_management_system" },
            ...
            imageSrc={heroData?.mediaUrl || "/effy_edu_management_system/images/gallery-classroom.png"}
          />
        </section>
