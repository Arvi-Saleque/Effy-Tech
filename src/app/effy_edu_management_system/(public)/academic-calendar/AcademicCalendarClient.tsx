...
export default function AcademicCalendarClient({
  ...
  const calendarImageSrc = cardData?.mediaUrl || cardData?.fileUrl || heroData?.fileUrl || heroData?.mediaUrl || "/effy_edu_management_system/images/flyer_hsc26_hsc27.jpg";
    ...
    <div className="min-h-screen bg-[#FFF9F2] pt-24 pb-24 relative overflow-hidden">
      ...
      <div className="brand-container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 relative z-10">
        ...
        <InnerPageHero
          ...
          description={heroData?.description || "Stay ahead with Lead Instructor's complete academic roadmap, exam schedules, class routines, and batch milestones."}
          breadcrumbs={[
          ...
          <div className="flex items-center justify-between pb-4 sm:pb-6 border-b border-gray-100 mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                download="EduPilot-Coaching-Academy-Academic-Calendar.jpg"
                target="_blank"
