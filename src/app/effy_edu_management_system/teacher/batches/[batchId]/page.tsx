  ...
  return (
    <div className="space-y-8">
      ...
      <DashboardPageHeader
        ...
        actions={
          <Link
            href="/effy_edu_management_system/teacher/batches"
      ...
      <div className="flex border-b border-border/40 gap-4 overflow-x-auto text-xs font-bold text-muted">
        <Link
          href={`/effy_edu_management_system/teacher/batches/${batchId}?tab=overview`}
        ...
        <Link
          href={`/effy_edu_management_system/teacher/batches/${batchId}/students`}
        ...
        <Link
          href={`/effy_edu_management_system/teacher/academic/${batchId}`}
          className="pb-3 px-1 transition-all border-b-2 border-transparent hover:text-primary"
        >
          Academics ({subjectsCount ?? 0})
        </Link>
        <Link
          href={`/effy_edu_management_system/teacher/batches/${batchId}?tab=payments`}
          className={`pb-3 px-1 transition-all border-b-2 hover:text-primary ${
        ...
        <Link
          href={`/effy_edu_management_system/teacher/batches/${batchId}?tab=materials`}
          className={`pb-3 px-1 transition-all border-b-2 hover:text-primary ${
        ...
        <Link
          href={`/effy_edu_management_system/teacher/batches/${batchId}/exams`}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-semibold pt-2 text-primary">
                ...
                <div>
                  ...
                  <span className="font-extrabold mt-0.5 block">
                    {schedule?.daysText || "Not Set"} &bull; {schedule?.time || "Not Set"}
                  </span>
                </div>
                <div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-border/40 shadow-sm space-y-4">
              <div className="flex justify-between items-center border-b border-border/20 pb-3">
                ...
                <Link
                  href={`/effy_edu_management_system/teacher/batches/${batchId}/payments`}
                        ...
                        return (
                          <tr key={p.id} className="hover:bg-slate-50/20">
                            ...
                            <td className="py-2.5 text-right">
                              <Link href={`/effy_edu_management_system/teacher/payments/${p.id}`} className="px-2 py-1 text-[9px] border rounded hover:bg-slate-50">Manage</Link>
                            </td>
                          </tr>
                        );
                      })}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 text-xs font-bold text-primary">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-border/40 shadow-sm space-y-4">
              <div className="flex justify-between items-center border-b border-border/20 pb-3">
                ...
                <Link
                  href={`/effy_edu_management_system/teacher/batches/${batchId}/materials`}
                  className="text-[10px] text-primary hover:underline"
                >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-5 rounded-2xl border border-border/40 shadow-sm space-y-4">
              ...
              <Link
                href={`/effy_edu_management_system/teacher/materials/new?batchId=${batchId}`}
            ...
            <div className="bg-white p-5 rounded-2xl border border-border/40 shadow-sm space-y-4">
              <div className="flex justify-between items-center border-b border-border/20 pb-2">
                ...
                <Link
                  href={`/effy_edu_management_system/teacher/batches/${batchId}/announcements`}
