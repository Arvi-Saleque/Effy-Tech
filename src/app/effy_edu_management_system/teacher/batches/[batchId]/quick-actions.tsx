...
import { updateBatchStatusAction, deleteBatchAction } from "@/app/effy_edu_management_system/actions/teacher";
  ...
  return (
    <div className="bg-white p-5 rounded-2xl border border-border/40 shadow-sm space-y-4 text-xs font-bold text-primary relative">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        {/* Edit */}
        <Link
          href={`/effy_edu_management_system/teacher/batches/${batchId}/edit`}
