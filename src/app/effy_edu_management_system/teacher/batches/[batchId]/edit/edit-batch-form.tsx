...
import { batchSchema, type BatchFormInput } from "@/features/effy-edu-demo/lib/validations/batch";
import { updateBatchAction } from "@/app/effy_edu_management_system/actions/teacher";
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (!res.success) {
        ...
        router.push(`/effy_edu_management_system/teacher/batches/${batch.id}`);
        router.refresh();
      }
    } catch (err: any) {
