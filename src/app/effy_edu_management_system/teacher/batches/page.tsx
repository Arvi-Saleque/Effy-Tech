...
import { BatchListActions } from "@/features/effy-edu-demo/components/dashboard/batch-list-actions";
  ...
  return (
    <div className="space-y-8">
      ...
      <DashboardPageHeader
        ...
        actions={
          <Link
            href="/effy_edu_management_system/teacher/batches/new"
                  ...
                  return (
                    <tr key={batch.id} className="hover:bg-slate-50/30 transition-colors">
                      ...
                      <td className="py-4.5 px-6">
                        <Link
                          href={`/effy_edu_management_system/teacher/batches/${batch.id}`}
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between px-6 py-4 border-t border-border/30 bg-slate-50/50">
            ...
            <div className="flex gap-2">
              <Link
                href={`/effy_edu_management_system/teacher/batches?page=${page - 1}&search=${search}&status=${status}&admissionOpen=${admissionOpen}&subject=${subject}&level=${level}`}
