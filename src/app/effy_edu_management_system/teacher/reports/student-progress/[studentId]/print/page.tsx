...
import { AutoPrintReport } from "@/features/effy-edu-demo/components/reports/auto-print-report";
import { StudentProgressReportCard } from "@/features/effy-edu-demo/components/reports/student-progress-report-card";
import { getStudentProgressReportData } from "@/features/effy-edu-demo/lib/reports/student-progress-report-data";
    ...
    <>
      ...
      <div className="mx-auto min-h-screen max-w-[230mm] p-4 sm:p-6 print:max-w-none print:p-0">
        <div className="report-print-actions mb-4 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm">
          <Link
            href={`/effy_edu_management_system/teacher/reports/student-progress/${studentId}?batchId=${encodeURIComponent(batchId)}`}
          ...
          <div className="flex gap-2">
            <a
              href={`/effy_edu_management_system/api/teacher/reports/student-progress/${studentId}/pdf?batchId=${encodeURIComponent(batchId)}`}
