  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3 print:hidden">
        <Link
          href={`/effy_edu_management_system/teacher/reports/student-progress?${query}&studentId=${encodeURIComponent(studentId)}`}
        ...
        <div className="flex flex-wrap gap-2">
          <Link
            href={`/effy_edu_management_system/teacher/reports/student-progress/${studentId}/print?${query}`}
            target="_blank"
          ...
          <Link
            href={`/effy_edu_management_system/api/teacher/reports/student-progress/${studentId}/pdf?${query}`}
