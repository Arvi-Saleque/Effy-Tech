...
import { createPaymentAction } from "@/app/effy_edu_management_system/actions/payments";
      ...
      {errorMessage && (
        <div className="p-3.5 bg-rose-50 border border-rose-100 rounded-xl text-rose-700 text-xs font-bold space-y-2">
          ...
          {duplicateId && (
            <button
              type="button"
              onClick={() => router.push(`/effy_edu_management_system/teacher/payments/${duplicateId}`)}
