...
import { DebouncedSearchInput } from "@/features/effy-edu-demo/components/ui/debounced-search-input";
...
import { PaymentListActions } from "@/features/effy-edu-demo/components/dashboard/payment-list-actions";
      ...
      <DashboardPageHeader
        ...
        actions={
          <div className="flex gap-3">
            <Link
              href="/effy_edu_management_system/teacher/payments/new"
        ...
        <div className="bg-white p-5 rounded-2xl border border-border/40 shadow-sm space-y-5 h-fit">
          ...
          <form method="GET" className="space-y-4">
            ...
            <div className="flex flex-col gap-2 pt-1">
              ...
              <Link
                href="/effy_edu_management_system/teacher/payments"
                ...
                {totalPages > 1 && (
                  <div className="flex justify-between items-center pt-4 border-t border-border/20">
                    ...
                    <div className="flex gap-2">
                      <Link
                        href={`/effy_edu_management_system/teacher/payments?month=${month}&year=${year}&batch=${batchId}&status=${status}&method=${paymentMethod}&search=${search}&page=${currentPage - 1}`}
