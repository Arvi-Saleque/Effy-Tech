...
import {
  ...
  enrollStudentAction
} from "@/app/effy_edu_management_system/actions/teacher";
import { deleteStudentByAdminAction } from "@/app/effy_edu_management_system/actions/profiles";
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      if (!res.success) {
        ...
        router.push("/effy_edu_management_system/teacher/students");
      }
    } catch (err) {
      console.error(err);
