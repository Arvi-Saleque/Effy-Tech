...
import { studentProfileTeacherEditSchema } from "@/features/effy-edu-demo/lib/validations/profiles";
import { updateStudentProfileByTeacherAction } from "@/app/effy_edu_management_system/actions/profiles";
import {
  Phone,
  MapPin,
  Calendar,
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        router.refresh();
        setTimeout(() => {
          router.push(`/effy_edu_management_system/teacher/students/${studentId}`);
        }, 1500);
      } else {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-5 rounded-2xl border border-border/40 shadow-sm space-y-3">
            ...
            <button
              type="button"
              onClick={() => router.push(`/effy_edu_management_system/teacher/students/${studentId}`)}
