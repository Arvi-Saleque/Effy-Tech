...
import { StudentListActions } from "@/features/effy-edu-demo/components/dashboard/student-list-actions";
    ...
    <div className="space-y-8">
      ...
      <form method="GET" className="bg-white p-5 rounded-2xl border border-border/40 shadow-sm space-y-4">
        ...
        <div className="flex justify-end gap-2.5 pt-2 border-t border-border/20">
          <Link
            href="/effy_edu_management_system/teacher/students"
                  ...
                  return (
                    <tr key={student.id} className="hover:bg-slate-50/30 transition-colors">
                      ...
                      <td className="py-4 px-6">
                        <Link
                          href={`/effy_edu_management_system/teacher/students/${student.id}`}
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between px-6 py-4 border-t border-border/30 bg-slate-50/50">
            ...
            <div className="flex gap-2">
              <Link
                href={`/effy_edu_management_system/teacher/students?page=${page - 1}&search=${search}&regStatus=${regStatus}&accStatus=${accStatus}&batchId=${batchId}&hasActiveBatch=${hasActiveBatch}`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
        {pendingList.map((st: any) => (
          <div key={st.id} className="bg-white border border-amber-200/40 rounded-xl p-4 flex items-center justify-between shadow-sm hover:shadow-md transition-shadow">
            ...
            <Link
              href={`/effy_edu_management_system/teacher/students/${st.id}`}
