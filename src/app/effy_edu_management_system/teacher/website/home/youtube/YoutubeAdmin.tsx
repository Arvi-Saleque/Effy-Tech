...
import { youtubeClasses as defaultYoutubeClasses, YouTubeClass } from "@/features/effy-edu-demo/data/youtubeClasses";
...
export default function YoutubeAdmin({ initialSectionData }: { initialSectionData: any }) {
  ...
  const [headerData, setHeaderData] = useState(content.header || {
    ...
    description: "Experience Lead Instructor's pedagogy. Select a lecture from the playlist below to load it directly into the theater screen.",
