...
import { teachingMethods as defaultTeachingMethods } from "@/features/effy-edu-demo/data/site";
...
export default function MeetTeacherAdmin({ initialSectionData }: { initialSectionData: any }) {
  ...
  const [teacherSubtitle, setTeacherSubtitle] = useState(content.teacherSubtitle || "Physics & Mathematics");
  const [teacherImage, setTeacherImage] = useState(content.teacherImage || "/effy_edu_management_system/images/demo-instructor.png");
