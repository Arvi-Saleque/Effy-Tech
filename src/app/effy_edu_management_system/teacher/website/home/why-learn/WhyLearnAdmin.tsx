...
import { benefits as defaultBenefits } from "@/features/effy-edu-demo/data/site";
import { availableStatsIcons, getIconComponent } from "@/features/effy-edu-demo/components/home/stats-icons";
...
export default function WhyLearnAdmin({ initialSectionData }: { initialSectionData: any }) {
  ...
  const [introData, setIntroData] = useState({
    ...
    highlightedText: content.highlightedText || "Lead Instructor?",
