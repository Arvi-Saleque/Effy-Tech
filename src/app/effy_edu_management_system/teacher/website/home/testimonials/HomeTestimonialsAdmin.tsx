...
export default function HomeTestimonialsAdmin({
  ...
  const [description, setDescription] = useState(initialSectionData?.description || "Honest feedback from students who achieved Board A+ and cracked engineering university admissions under Lead Instructor's guidance.");
  ...
  useEffect(() => {
    ...
    setDescription(initialSectionData?.description || "Honest feedback from students who achieved Board A+ and cracked engineering university admissions under Lead Instructor's guidance.");
  }, [initialSectionData]);
