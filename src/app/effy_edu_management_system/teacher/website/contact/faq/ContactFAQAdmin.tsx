...
export default function ContactFAQAdmin({ initialSectionData }: { initialSectionData: any }) {
  const defaultFaqs: FAQItem[] = [
    { id: generateId(), question: "Where is the coaching center located?", answer: "Our offline facility is located at Education Avenue, Dhaka." },
    { id: generateId(), question: "How can I join the coaching?", answer: "To enroll, please contact Lead Instructor directly on WhatsApp or over the phone." }
  ];
