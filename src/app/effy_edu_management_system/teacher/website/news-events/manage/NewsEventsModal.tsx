...
import { upsertSectionItem } from "@/features/effy-edu-demo/features/website-cms/actions/content-actions";
...
export default function NewsEventsModal({
  ...
  const [location, setLocation] = useState(meta.location || "EduPilot Coaching Academy Campus, Dhaka");
  ...
  const [imageUrl, setImageUrl] = useState(item?.mediaUrl || meta.imageUrl || "/effy_edu_management_system/images/gallery-event.png");
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="EduPilot Coaching Academy Campus, 3rd Floor, Dhaka"
              className="w-full px-3 py-2 rounded-xl border border-border text-sm focus:ring-2 focus:ring-accent"
            />
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                placeholder="/effy_edu_management_system/images/gallery-event.png"
                className="w-full px-3 py-2 rounded-xl border border-border text-sm focus:ring-2 focus:ring-accent"
              />
              <button
                type="button"
