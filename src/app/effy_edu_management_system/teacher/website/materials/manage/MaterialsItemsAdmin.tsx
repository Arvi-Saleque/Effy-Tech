...
import { deleteSectionItem } from "@/features/effy-edu-demo/features/website-cms/actions/content-actions";
      ...
      {items.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {items.map((item) => {
            ...
            const imgUrl = item.mediaUrl || (meta.fileType === "IMAGE" ? meta.fileUrl : "/effy_edu_management_system/placeholder.jpg");
