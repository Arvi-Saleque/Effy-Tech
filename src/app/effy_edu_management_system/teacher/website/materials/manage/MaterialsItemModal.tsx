...
import { getPreSignedUploadUrl } from "@/app/effy_edu_management_system/actions/r2-upload";
...
export default function MaterialsItemModal({ item, categories, onClose, onSave }: MaterialsItemModalProps) {
  ...
  const handlePdfUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const r2PreviewUrl = `/effy_edu_management_system/api/resource?key=${encodeURIComponent(urlResult.r2Key)}`;
