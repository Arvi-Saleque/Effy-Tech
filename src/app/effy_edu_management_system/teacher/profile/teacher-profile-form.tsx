...
import { teacherProfileSelfSchema } from "@/features/effy-edu-demo/lib/validations/profiles";
import { updateTeacherProfileSelfAction, uploadAvatarAction } from "@/app/effy_edu_management_system/actions/profiles";
      ...
      <div className="lg:col-span-2">
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-6 rounded-2xl border border-border/40 shadow-sm space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. EduPilot Coaching Academy"
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. +8801700000000, hello@edupilot.demo"
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-border/30">
            <button
              type="button"
              onClick={() => router.push("/effy_edu_management_system/teacher")}
