...
import { AssignmentFilters } from "@/features/effy-edu-demo/components/assignments/assignment-filters";
...
import { assignmentStatuses } from "@/features/effy-edu-demo/lib/validations/assignments";
  ...
  return (
    <div className="space-y-7">
      <DashboardPageHeader
        ...
        actions={
          <Link href="/effy_edu_management_system/teacher/assignments/new" className="primary-btn inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-xs font-black">
      ...
      {assignments.length === 0 ? (
        <div className="rounded-3xl border border-dashed border-slate-300 bg-white p-12 text-center">
          ...
          <Link href="/effy_edu_management_system/teacher/assignments/new" className="primary-btn mt-5 inline-flex items-center gap-2 rounded-xl px-5 py-2.5 text-xs font-black"><Plus className="h-4 w-4" /> Create assignment</Link>
        </div>
      ) : (
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {assignments.map((assignment) => {
            ...
            return (
              <Link key={assignment.id} href={`/effy_edu_management_system/teacher/assignments/${assignment.id}`} className="group rounded-3xl border border-border/60 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-950/8">
