      ...
      <div className="flex flex-wrap items-center gap-2 bg-white p-2 rounded-2xl border border-border/40 shadow-xs">
        {[
          ...
          return (
            <Link
              key={tab.id}
              href={`/effy_edu_management_system/teacher/audit-logs?category=${tab.id}&action=${filterAction}&entityType=${filterEntityType}&startDate=${filterStartDate}&endDate=${filterEndDate}`}
      ...
      <div className="bg-white p-5 rounded-2xl border border-border/40 shadow-sm space-y-4">
        <form method="GET" className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3 items-end">
          ...
          <div className="flex gap-2">
            ...
            <Link
              href="/effy_edu_management_system/teacher/audit-logs"
      ...
      <div className="bg-white rounded-2xl border border-border/40 shadow-sm overflow-hidden">
        ...
        {totalPages > 1 && (
          <div className="flex justify-between items-center p-4 border-t border-border/20 bg-slate-50/50">
            ...
            <div className="flex gap-2">
              <Link
                href={`/effy_edu_management_system/teacher/audit-logs?category=${activeCategory}&action=${filterAction}&entityType=${filterEntityType}&startDate=${filterStartDate}&endDate=${filterEndDate}&page=${currentPage - 1}`}
