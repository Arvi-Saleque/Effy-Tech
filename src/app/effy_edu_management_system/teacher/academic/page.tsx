      ...
      <DashboardPageHeader
        ...
        actions={
          <div className="flex flex-wrap items-center gap-2">
            <Link
              href="/effy_edu_management_system/teacher/assignments"
            ...
            <Link
              href="/effy_edu_management_system/teacher/reports/academic"
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {academicBatches.map((batch) => {
              ...
              return (
                <Link
                  key={batch.id}
                  href={`/effy_edu_management_system/teacher/academic/${batch.id}`}
