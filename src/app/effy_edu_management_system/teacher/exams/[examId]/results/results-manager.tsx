...
import { saveDraftResultsAction, publishResultsAction, unpublishResultsAction } from "@/app/effy_edu_management_system/actions/exams";
import {
  Loader2,
  Search,
  Filter,
...
import { calculateGrade, calculatePassFailStatus } from "@/features/effy-edu-demo/lib/exams/grading";
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-4 rounded-xl border border-border shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <a href={`/effy_edu_management_system/api/teacher/exams/${examId}/result-pdf`} download className="bg-[#010E62] hover:bg-blue-900 text-white font-semibold text-sm px-4 py-2 rounded-lg shadow-xs flex items-center gap-2 transition-colors">
