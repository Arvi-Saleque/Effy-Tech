...
import { announcementSchema } from "@/features/effy-edu-demo/lib/validations/materials";
...
export async function createAnnouncementAction(rawInput: unknown) {
  try {
    ...
    revalidatePath(`/effy_edu_management_system/teacher/batches/${newAnnouncement.batch_id}/announcements`);
    revalidatePath(`/effy_edu_management_system/student/batches/${newAnnouncement.batch_id}/announcements`);
    revalidatePath(`/effy_edu_management_system/teacher/academic/${newAnnouncement.batch_id}`);
    revalidatePath(`/effy_edu_management_system/student/batches/${newAnnouncement.batch_id}/academics`);
...
export async function updateAnnouncementAction(announcementId: string, rawInput: unknown) {
  try {
    ...
    revalidatePath(`/effy_edu_management_system/teacher/batches/${updatedAnnouncement.batch_id}/announcements`);
    revalidatePath(`/effy_edu_management_system/student/batches/${updatedAnnouncement.batch_id}/announcements`);
    revalidatePath(`/effy_edu_management_system/teacher/academic/${updatedAnnouncement.batch_id}`);
    revalidatePath(`/effy_edu_management_system/student/batches/${updatedAnnouncement.batch_id}/academics`);
...
export async function deleteAnnouncementAction(announcementId: string) {
  try {
    ...
    revalidatePath(`/effy_edu_management_system/teacher/batches/${announcement.batch_id}/announcements`);
    revalidatePath(`/effy_edu_management_system/student/batches/${announcement.batch_id}/announcements`);
    revalidatePath(`/effy_edu_management_system/teacher/academic/${announcement.batch_id}`);
    revalidatePath(`/effy_edu_management_system/student/batches/${announcement.batch_id}/academics`);
    revalidatePath(`/effy_edu_management_system/teacher/announcements`);
    return { success: true };
  } catch (err: unknown) {
    return { success: false, message: getErrorMessage(err) };
  }
