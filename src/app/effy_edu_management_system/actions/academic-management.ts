...
function revalidateAcademicWorkspace(batchId: string) {
  revalidatePath("/effy_edu_management_system/teacher/academic");
  ...
  revalidatePath(`/effy_edu_management_system/teacher/batches/${batchId}/exams`);
  revalidatePath(`/effy_edu_management_system/student/batches/${batchId}`);
  revalidatePath(`/effy_edu_management_system/student/batches/${batchId}/exams`);
