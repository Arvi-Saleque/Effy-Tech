...
} from "@/features/effy-edu-demo/lib/validations/class-routine";
...
function revalidateRoutinePaths(batchId?: string, sessionId?: string) {
  revalidatePath("/effy_edu_management_system/teacher/routine");
  revalidatePath("/effy_edu_management_system/student/routine");
  ...
  if (batchId) {
    ...
    revalidatePath(`/effy_edu_management_system/student/batches/${batchId}/academics`);
  }
  if (sessionId) revalidatePath(`/effy_edu_management_system/teacher/routine/${sessionId}/edit`);
}
