...
import { materialSchema } from "@/features/effy-edu-demo/lib/validations/materials";
import {
  uploadPrivateAsset,
  deletePrivateAsset,
  generatePublicId,
  ...
  sanitizeFilename,
} from "@/features/effy-edu-demo/lib/cloudinary";
import { deleteR2File } from "@/features/effy-edu-demo/lib/r2";
import { validateUploadedFile, validateFileMagicBytes } from "@/features/effy-edu-demo/lib/cloudinary/validation";
...
export async function createMaterialAction(formData: FormData) {
  ...
  try {
    ...
    revalidatePath(`/effy_edu_management_system/teacher/batches/${newMaterial.batch_id}/materials`);
    revalidatePath(`/effy_edu_management_system/student/batches/${newMaterial.batch_id}/materials`);
    revalidatePath(`/effy_edu_management_system/teacher/academic/${newMaterial.batch_id}`);
    revalidatePath(`/effy_edu_management_system/student/batches/${newMaterial.batch_id}/academics`);
...
export async function updateMaterialAction(contentId: string, formData: FormData) {
  ...
  try {
    ...
    revalidatePath(`/effy_edu_management_system/teacher/batches/${updatedMaterial.batch_id}/materials`);
    revalidatePath(`/effy_edu_management_system/student/batches/${updatedMaterial.batch_id}/materials`);
    revalidatePath(`/effy_edu_management_system/teacher/academic/${updatedMaterial.batch_id}`);
    revalidatePath(`/effy_edu_management_system/student/batches/${updatedMaterial.batch_id}/academics`);
...
export async function deleteMaterialAction(contentId: string) {
  try {
    ...
    revalidatePath(`/effy_edu_management_system/teacher/batches/${material.batch_id}/materials`);
    revalidatePath(`/effy_edu_management_system/student/batches/${material.batch_id}/materials`);
    revalidatePath(`/effy_edu_management_system/teacher/academic/${material.batch_id}`);
    revalidatePath(`/effy_edu_management_system/student/batches/${material.batch_id}/academics`);
    return { success: true };
  } catch (err: any) {
    return { success: false, message: err.message || "Internal server error" };
  }
