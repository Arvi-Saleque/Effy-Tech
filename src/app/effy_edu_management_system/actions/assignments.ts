...
import {
  ...
  requireTeacher,
} from "@/features/effy-edu-demo/lib/auth-guards";
...
} from "@/features/effy-edu-demo/lib/validations/assignments";
...
function revalidateAssignmentPaths(batchId?: string, assignmentId?: string) {
  revalidatePath("/effy_edu_management_system/teacher/assignments");
  revalidatePath("/effy_edu_management_system/student/assignments");
  revalidatePath("/effy_edu_management_system/student");
  if (batchId) {
    revalidatePath(`/effy_edu_management_system/teacher/academic/${batchId}`);
    revalidatePath(`/effy_edu_management_system/student/batches/${batchId}`);
  }
  if (assignmentId) {
    revalidatePath(`/effy_edu_management_system/teacher/assignments/${assignmentId}`);
    revalidatePath(`/effy_edu_management_system/student/assignments/${assignmentId}`);
  }
}
