...
import { createNotification, createNotificationForProfile } from "@/features/effy-edu-demo/lib/notifications";
import { batchSchema } from "@/features/effy-edu-demo/lib/validations/batch";
import { deletePrivateAsset } from "@/features/effy-edu-demo/lib/cloudinary";
...
export async function createBatchAction(rawInput: any) {
  try {
    ...
    revalidatePath("/effy_edu_management_system/teacher/batches");
...
export async function deleteBatchAction(batchId: string) {
  try {
    ...
    revalidatePath("/effy_edu_management_system/teacher/materials");
    revalidatePath("/effy_edu_management_system/teacher/enrollments");
  ...
  if (student.registration_status === "PENDING") {
    ...
    if (count && count > 0) {
      ...
      await createNotificationForProfile({
        ...
        message: "Your student registration has been approved. Welcome to EduPilot Coaching Academy!",
...
export async function updateEnrollmentStatusAction({
  ...
  try {
    ...
    revalidatePath("/effy_edu_management_system/teacher/students");
    revalidatePath(`/effy_edu_management_system/teacher/students/${enrollment.student_id}`);
    revalidatePath(`/effy_edu_management_system/teacher/batches/${enrollment.batch_id}`);
    revalidatePath(`/effy_edu_management_system/teacher/enrollments`);
...
export async function updateStudentAccountStatusAction({
  ...
  try {
    ...
    revalidatePath("/effy_edu_management_system/teacher/students");
    revalidatePath(`/effy_edu_management_system/teacher/students/${profileId}`);
