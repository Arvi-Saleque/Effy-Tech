...
import { passwordChangeSchema } from "@/features/effy-edu-demo/lib/validations/profiles";
...
/**
 * Returns the stable student code used by the standalone demo.
 * No service-role client or database lookup is required.
 */
export async function getStudentCodeByUserId(userId: string) {
  return userId ? "EDU-2026001" : null;
}
