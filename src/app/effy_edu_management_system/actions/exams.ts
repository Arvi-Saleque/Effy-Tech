...
import { examSchema } from "@/features/effy-edu-demo/lib/validations/exams";
import { calculateGrade, calculatePassFailStatus, calculateCompetitionRanks } from "@/features/effy-edu-demo/lib/exams/grading";
...
export async function createExamAction(formData: FormData) {
  try {
    ...
    revalidatePath(`/effy_edu_management_system/teacher/batches/${newExam.batch_id}/exams`);
    revalidatePath(`/effy_edu_management_system/teacher/academic/${newExam.batch_id}`);
    revalidatePath(`/effy_edu_management_system/student/batches/${newExam.batch_id}/exams`);
...
export async function updateExamAction(examId: string, formData: FormData) {
  try {
    ...
    revalidatePath(`/effy_edu_management_system/teacher/exams`);
    revalidatePath(`/effy_edu_management_system/teacher/batches/${updatedExam.batch_id}/exams`);
    revalidatePath(`/effy_edu_management_system/teacher/academic/${updatedExam.batch_id}`);
    revalidatePath(`/effy_edu_management_system/student/batches/${updatedExam.batch_id}/exams`);
    revalidatePath(`/effy_edu_management_system/student`);
...
export async function saveDraftResultsAction(
  ...
  try {
    ...
    revalidatePath(`/effy_edu_management_system/teacher/exams/${examId}/results`);
    revalidatePath(`/effy_edu_management_system/teacher/academic/${exam.batch_id}`);
    return { success: true };
  } catch (err: any) {
    return { success: false, message: err.message || "Internal server error" };
  }
...
export async function publishResultsAction(examId: string, publicationNote: string) {
  try {
    ...
    revalidatePath(`/effy_edu_management_system/teacher/exams/${examId}`);
    revalidatePath(`/effy_edu_management_system/teacher/academic/${exam.batch_id}`);
    revalidatePath(`/effy_edu_management_system/student/batches/${exam.batch_id}/exams`);
    revalidatePath(`/effy_edu_management_system/student/results`);
    return { success: true, exam: updatedExam };
  } catch (err: any) {
    return { success: false, message: err.message || "Internal server error" };
  }
...
export async function deleteExamAction(examId: string) {
  try {
    ...
    revalidatePath(`/effy_edu_management_system/teacher/batches/${exam.batch_id}/exams`);
    revalidatePath(`/effy_edu_management_system/teacher/exams`);
    return { success: true };
  } catch (err: any) {
    return { success: false, message: err.message || "Internal server error" };
