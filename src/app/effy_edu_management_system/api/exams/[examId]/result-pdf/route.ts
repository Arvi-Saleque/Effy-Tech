...
import { getExamResultDocumentData } from "@/features/effy-edu-demo/lib/exams/result-document-data";
import { ExamResultDocument } from "@/features/effy-edu-demo/pdf/ExamResultDocument";
...
export async function GET(
  ...
  try {
    ...
    const { destination } = await resolveAuthenticatedDestination(undefined, "STUDENT");
