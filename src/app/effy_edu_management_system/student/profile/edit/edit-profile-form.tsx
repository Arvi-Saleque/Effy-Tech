...
import { studentProfileSelfSchema } from "@/features/effy-edu-demo/lib/validations/profiles";
import { updateStudentProfileSelfAction, uploadAvatarAction } from "@/app/effy_edu_management_system/actions/profiles";
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        router.refresh();
        setTimeout(() => {
          router.push("/effy_edu_management_system/student/profile");
        }, 1500);
      } else {
      ...
      <div className="lg:col-span-2">
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-6 rounded-2xl border border-border/40 shadow-sm space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-border/30">
            <button
              type="button"
              onClick={() => router.push("/effy_edu_management_system/student/profile")}
