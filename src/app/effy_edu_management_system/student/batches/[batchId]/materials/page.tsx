...
import { StudentMaterialList } from "@/features/effy-edu-demo/components/materials/StudentMaterialList";
...
export default async function StudentBatchMaterialsPage({ params, searchParams }: PageProps) {
  ...
  if (!enrollment) redirect("/effy_edu_management_system/student?error=unauthorized_batch");
  ...
  return (
    <div className="space-y-8 text-xs font-bold text-slate-800">
      ...
      <div className="space-y-4">
        <Link
          href={`/effy_edu_management_system/student/batches/${batchId}`}
