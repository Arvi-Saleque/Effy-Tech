              ...
              return (
                <article key={session.id} className={`rounded-3xl border bg-white p-5 shadow-sm ${isToday && session.status === "SCHEDULED" ? "border-blue-300 ring-4 ring-blue-50" : "border-border/60"}`}>
                  ...
                  <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
                    <Link href={`/effy_edu_management_system/student/batches/${session.batch_id}/academics`} className="inline-flex items-center gap-1.5 text-[10px] font-black text-blue-700 hover:underline"><BookOpenCheck className="h-3.5 w-3.5" /> Academic journey</Link>
