...
import { markNotificationReadAction, markAllNotificationsReadAction } from "@/app/effy_edu_management_system/actions/notifications";
...
export default function StudentNotificationsPage() {
  ...
  const getRedirectUrl = (entityType: string | null, entityId: string | null) => {
    ...
    if (type === "enrollments") return "/effy_edu_management_system/student";
    if (type === "payments") return "/effy_edu_management_system/student/payments";
    if (type === "batch_contents") return `/effy_edu_management_system/student/exams`; // redirect to generic batch exams/materials
    if (type === "exams") return `/effy_edu_management_system/student/exams`;
    if (type === "exam_result") return `/effy_edu_management_system/student/results`;
    return null;
  };
