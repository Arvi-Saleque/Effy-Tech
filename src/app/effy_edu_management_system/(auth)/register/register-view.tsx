...
import { getDistinctAcademicYears } from "@/app/effy_edu_management_system/actions/academic-years";
import { getStudentCodeByUserId } from "@/app/effy_edu_management_system/actions/auth";
...
export function RegisterView() {
  ...
  const onSubmit = async (data: RegisterInput) => {
    ...
    try {
      ...
      // This standalone demo does not send verification email.
    ...
    return (
      <div className="bg-white border border-border/60 rounded-2xl p-8 shadow-sm text-center max-w-lg mx-auto">
        ...
        <button
          type="button"
          onClick={() => {
            window.location.href = "/effy_edu_management_system/student";
          }}
