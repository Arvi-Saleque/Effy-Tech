      ...
      <section className="pgc-section">
        <div className="pgc-container pgc-content-grid">
          <article className="pgc-panel">
            ...
            <p>
              কলেজের পরিচিতি, নোটিশ, ভর্তি, পরীক্ষা, ফলাফল, বিভাগ, গ্যালারি ও
              শিক্ষার্থী সেবার তথ্য শিক্ষার্থী, অভিভাবক ও শুভানুধ্যায়ীদের জন্য
              সহজভাবে উপস্থাপন করা হয়েছে।
            </p>
