...
} from "@/app/effy_edu_management_system/actions/exams";
import {
  Eye,
  Edit,
  FileSpreadsheet,
...
export function ExamListActions({ examId, examName, status }: ExamListActionsProps) {
  ...
  return (
    <div className="relative flex items-center justify-end gap-1.5">
      ...
      {/* 0. View Details Icon */}
      <Link
        href={`/effy_edu_management_system/teacher/exams/${examId}`}
      ...
      {!isArchived && (
        <>
          {!isPublished ? (
            <Link
              href={`/effy_edu_management_system/teacher/exams/${examId}/edit`}
          ...
          <Link
            href={`/effy_edu_management_system/teacher/exams/${examId}/results`}
