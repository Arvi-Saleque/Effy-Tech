...
export function TeacherShell({
  ...
  const [adminMode, setAdminMode] = useState<"coaching" | "website">(() =>
    pathname?.startsWith("/effy_edu_management_system/teacher/website") ? "website" : "coaching"
  );

  useEffect(() => {
    if (pathname?.startsWith("/effy_edu_management_system/teacher/website") && adminMode !== "website") {
      setAdminMode("website");
    } else if (pathname && !pathname.startsWith("/effy_edu_management_system/teacher/website") && pathname.startsWith("/effy_edu_management_system/teacher") && adminMode === "website") {
