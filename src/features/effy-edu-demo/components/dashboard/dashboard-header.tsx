  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-border/40 bg-white/80 px-6 backdrop-blur-md">
      ...
      <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-1 rounded-xl border border-border/50 bg-bg p-1 shadow-sm">
            <button
              ...
              onClick={() => {
                ...
                router.push("/effy_edu_management_system/teacher");
              }}
            ...
            <button
              ...
              onClick={() => {
                ...
                router.push("/effy_edu_management_system/teacher/website");
              }}
              className={`rounded-lg px-2 py-1 sm:px-3 sm:py-1.5 text-[10px] sm:text-xs font-bold transition-all cursor-pointer ${
                adminMode === "website"
                  ? "bg-primary text-white shadow-sm"
        ...
        {/* Notification Bell */}
        <button
          onClick={() => router.push(role === "STUDENT" ? "/effy_edu_management_system/student/notifications" : "/effy_edu_management_system/teacher/notifications")}
          type="button"
              ...
              <div className="absolute right-0 mt-2.5 z-20 w-56 origin-top-right rounded-2xl border border-border/60 bg-white p-2 shadow-lg shadow-primary/5 focus:outline-none">
                ...
                <button
                  onClick={() => {
                    ...
                    router.push(role === "STUDENT" ? "/effy_edu_management_system/student/profile" : "/effy_edu_management_system/teacher/settings");
                  }}
