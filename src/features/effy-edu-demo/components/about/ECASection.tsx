...
import { ECAItem, SectionHeader } from "@/features/effy-edu-demo/data/about";
...
export default function ECASection({ ecaItems, header }: ECASectionProps) {
  ...
  return (
    <section className="py-24 bg-[#FFFDF8] relative overflow-hidden font-sans">
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[url('/effy_edu_management_system/noise.png')] opacity-[0.03] pointer-events-none mix-blend-overlay" />
