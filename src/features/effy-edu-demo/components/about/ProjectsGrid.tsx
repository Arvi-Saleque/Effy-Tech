...
import { ProjectItem, SectionHeader } from "@/features/effy-edu-demo/data/about";
            ...
            >
              ...
              <div className="p-8 lg:p-12 flex-1 flex flex-col justify-center">
                ...
                <div className="flex mt-auto pt-4">
                  <a
                    href={`/effy_edu_management_system/projects/${featuredProject.id}`}
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-1 w-full sm:w-[60%]">
                    ...
                    <div className="mt-auto pt-4 flex items-center justify-between border-t border-[#E7E0D2]/50">
                      <a
                        href={`/effy_edu_management_system/projects/${project.id}`}
