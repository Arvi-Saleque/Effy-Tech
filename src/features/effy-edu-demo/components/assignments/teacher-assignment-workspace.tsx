...
} from "@/app/effy_edu_management_system/actions/assignments";
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <Link href="/effy_edu_management_system/teacher/assignments" className="inline-flex items-center gap-2 text-xs font-black text-slate-500 transition hover:text-blue-700">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Link href={`/effy_edu_management_system/teacher/assignments/${assignment.id}/edit`} className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-xs font-black text-slate-600 transition hover:border-blue-200 hover:text-blue-700">
