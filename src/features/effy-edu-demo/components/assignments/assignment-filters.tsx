...
export function AssignmentFilters({
  ...
  return (
    <form className="grid gap-3 rounded-2xl border border-slate-200 bg-white p-4 md:grid-cols-[1.2fr_1fr_1fr_1fr_auto_auto] md:items-end">
      ...
      <Link href="/effy_edu_management_system/teacher/assignments" className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 px-4 py-2.5 text-xs font-black text-slate-500 transition hover:bg-slate-50">
