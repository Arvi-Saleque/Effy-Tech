      ...
      <div className="w-full relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-3.5">
                ...
                <div>
                  ...
                  <p className="text-sm text-text mt-1.5 leading-relaxed font-medium">
                    {content.transitInfo || `Conveniently located ${siteInfo.nearbyLandmark} in Dhaka. Easily accessible from all parts of the area by local transport (CNG/bus).`}
                  </p>
                </div>
              </div>
          ...
          <div className="lg:col-span-7 rounded-2xl overflow-hidden border border-border h-[320px] lg:h-auto min-h-[350px] relative glow-accent-gold shadow-sm bg-white">
            <iframe
              title="EduPilot Coaching Academy Physical Venue Map"
              src={mapUrl}
