      ...
      <div className="brand-container w-full z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left space-y-6 sm:space-y-8">
            ...
            >
              <a
                href="/effy_edu_management_system/contact"
              ...
              <a
                href="/effy_edu_management_system/about"
          ...
          <div
            ...
            title="Click to meet Lead Instructor"
          >
            {/* 3D Scene Layer */}
            ...
            <div className="relative w-full max-w-[280px] sm:max-w-[340px] aspect-[1/1.2] flex items-end justify-center z-10">
              ...
              <Image
                src={content.teacherImage || "/effy_edu_management_system/images/demo-instructor.png"}
                alt={teacherName}
                fill
