...
import { testimonials as fallbackTestimonials } from "@/features/effy-edu-demo/data/testimonials";
import { Star, X, Loader2 } from "lucide-react";
import { motion, AnimatePresence, useReducedMotion } from "framer-motion";
import toast from "react-hot-toast";
import { submitReview } from "@/features/effy-edu-demo/features/website-cms/actions/testimonials-actions";
    ...
    <section id="testimonials" className="brand-section-wrapper bg-bg-soft relative overflow-hidden">
      ...
      <div className="brand-container relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          >
            {headerData?.description || "Honest feedback from students who achieved Board A+ and cracked engineering university admissions under Lead Instructor's guidance."}
          </motion.p>
        </div>
        ...
        <div className="relative z-20 flex flex-wrap items-center justify-center gap-4 mt-10">
          <Link
            href="/effy_edu_management_system/reviews"
