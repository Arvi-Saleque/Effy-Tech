...
import { getCircularOffset } from "@/features/effy-edu-demo/lib/circular";
...
export default function CoursesSection({ courseItems = [], headerData }: { courseItems?: any[], headerData?: any }) {
  ...
  const mappedCourses = courseItems.map(item => {
    ...
    return {
      ...
      bannerImage: item.mediaUrl || meta.fallbackImageUrl || "/effy_edu_management_system/images/flyer_admission_science.jpg",
    ...
    <section id="courses" className="brand-section-wrapper bg-bg relative overflow-hidden">
      ...
      <div className="brand-container relative z-10">
        ...
        <div className="flex justify-center mt-10">
          <Link href="/effy_edu_management_system/courses" className="primary-btn inline-flex items-center space-x-2 text-sm px-8 py-3.5 shadow-md hover:scale-[1.02] active:scale-95 transition-transform">
