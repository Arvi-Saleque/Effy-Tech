...
export default function FAQSection({ faqData }: { faqData?: any }) {
  ...
  const displayFaqs = dynamicFaqs.length > 0 ? dynamicFaqs : [
    { id: "faq-1", question: "Where is the coaching center located?", answer: "Our offline facility is located at Education Avenue, Dhaka, Bangladesh." },
    { id: "faq-2", question: "How can I join the coaching?", answer: "To enroll, please contact Lead Instructor directly on WhatsApp or over the phone." },
                    ...
                    >
                      <div className="px-5 pb-5 sm:px-7 sm:pb-7 pt-2 bg-white relative z-0">
                        ...
                        <div className="relative bg-gradient-to-br from-[#FFFBF3] to-[#FFFDF9] rounded-2xl border border-[#F4EFE6] p-6 sm:p-8 overflow-hidden">
                          ...
                          <div className="absolute bottom-0 right-0 w-64 h-64 bg-[url('/effy_edu_management_system/noise.png')] opacity-[0.02] mix-blend-overlay pointer-events-none rounded-tl-full" />
