    ...
    <div className="flex min-h-[420px] items-center justify-center rounded-3xl border border-rose-100 bg-white p-6 text-center shadow-sm" role="alert">
      <div className="max-w-md">
        ...
        <div className="mt-6 flex flex-col justify-center gap-2 sm:flex-row">
          ...
          <Link href="/effy_edu_management_system" className="rounded-xl border border-slate-200 bg-white px-5 py-2.5 text-xs font-black text-slate-600 transition hover:bg-slate-50">
            Go to home
          </Link>
        </div>
