...
export default function SecurePdfViewer({
  ...
  const previewUrl = `/effy_edu_management_system/api/materials/${contentId}/access?mode=preview`;
  const downloadUrl = `/effy_edu_management_system/api/materials/${contentId}/access?mode=download`;
