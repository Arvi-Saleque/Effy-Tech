...
import { deleteMaterialAction, updateMaterialAction } from "@/app/effy_edu_management_system/actions/materials";
import {
  Search,
  Eye,
  Edit3,
...
export function TeacherMaterialsList({
  ...
  const newMaterialHref = targetBatchId
    ? `/effy_edu_management_system/teacher/materials/new?batchId=${targetBatchId}${targetSubjectId ? `&subjectId=${targetSubjectId}` : ""}`
    : "/effy_edu_management_system/teacher/materials/new";
                    ...
                    <tr key={material.id} className="hover:bg-slate-50/40 transition-colors">
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex justify-end items-center gap-2">
                          {hasFile && (
                            <a
                              href={`/effy_edu_management_system/api/materials/${material.id}/access?mode=preview`}
                              target="_blank"
                          ...
                          <Link
                            href={`/effy_edu_management_system/teacher/materials/${material.id}/edit`}
                            className="p-1.5 text-slate-500 hover:text-primary transition-colors hover:bg-slate-100 rounded-lg"
