...
export const siteInfo: SiteInfo = {
  ...
  footerNotice: "We do not offer automatic online enrollment or payments. To join our programs, please connect directly with Lead Instructor or visit our venue.",
  footerCopyright: `© ${new Date().getFullYear()} EduPilot Coaching Academy. All rights reserved.`,
  quickLinks: [
    { label: "Home", href: "#home" },
    { label: "Programs", href: "#courses" },
    { label: "Courses", href: "#courses" },
    { label: "News & Events", href: "/effy_edu_management_system/news-events" },
    { label: "Success Results", href: "#results" },
    { label: "Free Video Lectures", href: "#youtube-classes" },
    { label: "Meet Lead Instructor", href: "#teacher" },
    { label: "Student Login", href: "/effy_edu_management_system/login", isPortal: true },
    { label: "Admin Login", href: "/effy_edu_management_system/login", isPortal: true },
  ]
};
...
export const benefits: BenefitItem[] = [
  {
    ...
    description: "Direct mentorship from Lead Instructor, including target goal planning, parent alignment feedback, and personalized tracking.",
    iconName: "UserCheck",
  },
  {
  ...
  },
  {
    ...
    description: "Curated worksheets, handwritten concept books, and mathematical shortcut checklists compiled directly by Lead Instructor.",
