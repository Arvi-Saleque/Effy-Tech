 ...
 *
 * Centralized dynamic data repository for Lead Instructor's Academic Portfolio (/about).
...
export const profileData: ProfileInfo = {
  name: "Dr. Arif Rahman",
  role: "LEAD INSTRUCTOR & ACADEMIC DIRECTOR",
  ...
  greeting: "Hello, I'm",
  subtitle: "Physics, Mathematics & Admission Mentor",
  quote: "Understand the concept, practise the method, and measure the progress.",
  heroStats: [
    { iconName: "GraduationCap", label: "Educator", value: "10+ Years", subValue: "Teaching Experience" },
    { iconName: "Users", label: "Students Impacted", value: "1,200+", subValue: "And Growing" },
    { iconName: "Youtube", label: "Platforms", value: "Online", subValue: "& Classroom Programs" },
    { iconName: "MapPin", label: "Location", value: "Bangladesh", subValue: "Serving Learners" },
  ],
  socialLinks: [
...
export const metricsData: MetricItem[] = [
  { id: "m1", label: "Education", value: "BSc & MSc in Engineering Education", iconName: "GraduationCap" },
...
export const educationData: EducationItem[] = [
  { id: "e1", degree: "SSC", institution: "Model School & College", year: "2016", gpa: "GPA: 5.00", displayOrder: 1 },
  { id: "e2", degree: "HSC", institution: "Government Science College", year: "2018", gpa: "GPA: 5.00", displayOrder: 2 },
  { id: "e3", degree: "BSc in Engineering", institution: "Engineering University", year: "2020", gpa: "CGPA: 3.61 / 4.00", displayOrder: 3 },
  { id: "e4", degree: "MSc in Engineering Education", institution: "National University (Pursuing)", year: "Present", gpa: "—", displayOrder: 4 },
];
...
export const projectsData: ProjectItem[] = [
  {
    ...
    shortDescription: "Designed and simulated a standalone solar PV system for the Academic Building with battery storage to ensure reliable and sustainable power.",
    category: "Energy",
    iconName: "Sun",
    ...
    actionLinks: [
      { label: "View Details", url: "/effy_edu_management_system/projects/proj1", iconName: "ArrowRight", variant: "primary" },
  ...
  },
  {
    ...
    actionLinks: [
      { label: "View Details", url: "/effy_edu_management_system/projects/proj2", iconName: "ArrowRight", variant: "primary" }
    ],
    displayOrder: 2,
  },
  {
    ...
    actionLinks: [
      { label: "View Details", url: "/effy_edu_management_system/projects/proj3", iconName: "ArrowRight", variant: "primary" },
  ...
  },
  {
    ...
    actionLinks: [
      { label: "View Details", url: "/effy_edu_management_system/projects/proj4", iconName: "ArrowRight", variant: "primary" },
  ...
  },
  {
    id: "proj5",
    title: "Soccer Bot",
    shortDescription: "Arduino based remote-controlled soccer bot participated in Engineering University Science Carnival.",
    category: "Automation",
    iconName: "Bot",
    ...
    actionLinks: [
      { label: "View Details", url: "/effy_edu_management_system/projects/proj5", iconName: "ArrowRight", variant: "primary" },
  ...
  },
  {
    ...
    actionLinks: [
      { label: "View Details", url: "/effy_edu_management_system/projects/proj6", iconName: "ArrowRight", variant: "primary" },
  ...
  },
  {
    ...
    actionLinks: [
      { label: "View Details", url: "/effy_edu_management_system/projects/proj7", iconName: "ArrowRight", variant: "primary" },
      { label: "Code", url: "#", iconName: "Code", variant: "outline" }
    ],
    displayOrder: 7,
  }
