...
const siteSections: Record<string, DemoSection> = {
  ...
  "HOME|HOME_NEWS_EVENTS": section("HOME","HOME_NEWS_EVENTS",{eyebrow:"Latest Updates",title:"News & Events",description:"Admission notices, workshops, exams and academic celebrations.",content:{featuredId:"news-1",selectedRightIds:["news-2","news-3","news-4"]}}),
...
const sectionItems:Record<string,any[]> = {
  ...
  NEWS_EVENTS_ITEMS:[
    ...
    {id:"news-4",title:"HSC Revision Marathon Schedule Published",subtitle:"EVENT",body:"The intensive revision marathon schedule is now available with subject-wise problem-solving sessions and weekly assessments.",mediaUrl:"/effy_edu_management_system/images/flyer_revision_2026.jpg",sort_order:4,status:"PUBLISHED",metadata:{category:"EVENT",date:"27",month:"JUL",year:"2026",time:"3:30 PM",location:"Academic Building",excerpt:"A focused revision cycle covering core concepts, practice exams and final preparation.",featured:false}},
  ],
};
