...
import type { StudentProgressReportData } from "@/features/effy-edu-demo/lib/reports/student-progress-report-data";
...
export function StudentProgressReportDocument({
  ...
  const logoPath = path.join(process.cwd(), "public/images/edupilot-logo.svg");
